...
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/mtguardcyber/proxmox-helper-scripts/refs/heads/main/misc/copy-data/home-assistant-container-copy-data-home-assistant-core.sh)"
